...
namespace CalafiaRush
{
    ...
    public sealed class CalafiaRushInput : MonoBehaviour
    {
        ...
        private void Update()
        {
            LaneLeft = Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetKeyDown(KeyCode.A) || _leftHeld;
            LaneRight = Input.GetKeyDown(KeyCode.RightArrow) || Input.GetKeyDown(KeyCode.D) || _rightHeld;
